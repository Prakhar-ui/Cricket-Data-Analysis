...
def get_recent_cricket_data_every_2_days():
    ...
    @task()  
    def download_json_data_every_2_days():
        """
        Downloads and extracts JSON data from the provided URL.
        """
        data_url = "https://cricsheet.org/downloads/recently_added_2_json.zip"
        extract_to = os.path.normpath("json_files")
        zip_save_path = os.path.join(extract_to, "recently_added_2_json.zip")
        ...
        try:
            ...
            extract_path = os.path.join(extract_to, "recently_added_2_json")
    ...
    download_json_data_every_2_days()
